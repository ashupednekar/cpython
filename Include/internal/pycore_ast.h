...
asdl_comprehension_seq *_Py_asdl_comprehension_seq_new(Py_ssize_t size,
                                                       PyArena *arena);
...
asdl_excepthandler_seq *_Py_asdl_excepthandler_seq_new(Py_ssize_t size,
                                                       PyArena *arena);
...
asdl_match_case_seq *_Py_asdl_match_case_seq_new(Py_ssize_t size,
                                                 PyArena *arena);
...
asdl_type_ignore_seq *_Py_asdl_type_ignore_seq_new(Py_ssize_t size,
                                                   PyArena *arena);
...
asdl_type_param_seq *_Py_asdl_type_param_seq_new(Py_ssize_t size,
                                                 PyArena *arena);
