...
static PyObject *update_bases(PyObject *bases, PyObject *const *args,
                              Py_ssize_t nargs) {
  Py_ssize_t i, j;
...
static PyObject *builtin___build_class__(PyObject *self, PyObject *const *args,
                                         Py_ssize_t nargs, PyObject *kwnames) {
  PyObject *func, *name, *winner, *prep;
  PyObject *cls = NULL, *cell = NULL, *ns = NULL, *meta = NULL,
           *orig_bases = NULL;
  ...
  if (isclass) {
    ...
    winner =
        (PyObject *)_PyType_CalculateMetaclass((PyTypeObject *)meta, bases);
    if (winner == NULL) {
      goto error;
    }
    if (winner != meta) {
  ...
  if (cell != NULL) {
    ...
    if (cls != NULL && PyType_Check(cls) && PyCell_Check(cell)) {
      ...
      if (cell_cls != cls) {
        if (cell_cls == NULL) {
          const char *msg = "__class__ not set defining %.200R as %.200R. "
                            "Was __classcell__ propagated to type.__new__?";
          PyErr_Format(PyExc_RuntimeError, msg, name, cls);
        } else {
          const char *msg = "__class__ set to %.200R defining %.200R as %.200R";
...
static PyObject *builtin___import___impl(PyObject *module, PyObject *name,
...
static PyObject *builtin_all(PyObject *module, PyObject *iterable)
...
static PyObject *builtin_any(PyObject *module, PyObject *iterable)
...
static PyObject *builtin_ascii(PyObject *module, PyObject *obj)
...
static PyObject *builtin_bin(PyObject *module, PyObject *number)
...
static PyObject *builtin_callable(PyObject *module, PyObject *obj)
/*[clinic end generated code: output=2b095d59d934cb7e input=1423bab99cc41f58]*/
{
  return PyBool_FromLong((long)PyCallable_Check(obj));
}

static PyObject *builtin_breakpoint(PyObject *self, PyObject *const *args,
...
PyDoc_STRVAR(breakpoint_doc, "breakpoint($module, /, *args, **kws)\n\
--\n\
\n\
...
static PyObject *filter_vectorcall(PyObject *type, PyObject *const *args,
...
static void filter_dealloc(filterobject *lz) {
...
static int filter_traverse(filterobject *lz, visitproc visit, void *arg) {
  Py_VISIT(lz->it);
  Py_VISIT(lz->func);
  return 0;
}

static PyObject *filter_next(filterobject *lz) {
  PyObject *item;
  PyObject *it = lz->it;
  long ok;
  PyObject *(*iternext)(PyObject *);
...
static PyObject *filter_reduce(filterobject *lz, PyObject *Py_UNUSED(ignored)) {
...
PyDoc_STRVAR(filter_doc, "filter(function, iterable, /)\n\
--\n\
\n\
...
static PyObject *builtin_format_impl(PyObject *module, PyObject *value,
...
static PyObject *builtin_chr(PyObject *module, PyObject *i)
...
static PyObject *builtin_compile_impl(PyObject *module, PyObject *source,
                                      PyObject *filename, const char *mode,
                                      int flags, int dont_inherit, int optimize,
                                      int feature_version)
/*[clinic end generated code: output=b0c09c84f116d3d7 input=cc78e20e7c7682ba]*/
{
  ...
  str = _Py_SourceAsString(source, "compile", "string, bytes or AST", &cf,
                           &source_copy);
  if (str == NULL)
    goto error;
...
static PyObject *builtin_divmod_impl(PyObject *module, PyObject *x, PyObject *y)
...
static PyObject *builtin_eval_impl(PyObject *module, PyObject *source,
                                   PyObject *globals, PyObject *locals)
/*[clinic end generated code: output=0a0824aa70093116 input=7c7bce5299a89062]*/
{
  ...
  if (PyCode_Check(source)) {
    ...
    str = _Py_SourceAsString(source, "eval", "string, bytes or code", &cf,
                             &source_copy);
    if (str == NULL)
      goto error;
...
static PyObject *builtin_exec_impl(PyObject *module, PyObject *source,
                                   PyObject *globals, PyObject *locals,
                                   PyObject *closure)
/*[clinic end generated code: output=7579eb4e7646743d input=25e989b6d87a3a21]*/
{
  ...
  if (PyCode_Check(source)) {
    ...
    if (!closure) {
      ...
      v = PyEval_EvalCodeEx(source, globals, locals, NULL, 0, NULL, 0, NULL, 0,
                            NULL, closure);
    }
  } else {
    if (closure != NULL) {
    ...
    PyCompilerFlags cf = _PyCompilerFlags_INIT;
    cf.cf_flags = PyCF_SOURCE_IS_UTF8;
    str = _Py_SourceAsString(source, "exec", "string, bytes or code", &cf,
                             &source_copy);
    if (str == NULL)
      goto error;
...
/* AC: cannot convert yet, as needs PEP 457 group support in inspect */
static PyObject *builtin_getattr(PyObject *self, PyObject *const *args,
                                 Py_ssize_t nargs) {
...
static PyObject *builtin_globals_impl(PyObject *module)
...
static PyObject *builtin_hasattr_impl(PyObject *module, PyObject *obj,
                                      PyObject *name)
...
static PyObject *map_vectorcall(PyObject *type, PyObject *const *args,
                                size_t nargsf, PyObject *kwnames) {
  PyTypeObject *tp = _PyType_CAST(type);
...
static void map_dealloc(mapobject *lz) {
  PyObject_GC_UnTrack(lz);
  Py_XDECREF(lz->iters);
  Py_XDECREF(lz->func);
  Py_TYPE(lz)->tp_free(lz);
...
static int map_traverse(mapobject *lz, visitproc visit, void *arg) {
  Py_VISIT(lz->iters);
  Py_VISIT(lz->func);
  return 0;
}

static PyObject *map_next(mapobject *lz) {
...
static PyObject *map_reduce(mapobject *lz, PyObject *Py_UNUSED(ignored)) {
...
PyDoc_STRVAR(map_doc, "map(function, /, *iterables)\n\
--\n\
\n\
...
static PyObject *builtin_setattr_impl(PyObject *module, PyObject *obj,
...
static PyObject *builtin_delattr_impl(PyObject *module, PyObject *obj,
                                      PyObject *name)
...
static PyObject *builtin_hash(PyObject *module, PyObject *obj)
...
static PyObject *builtin_hex(PyObject *module, PyObject *number)
...
/* AC: cannot convert yet, as needs PEP 457 group support in inspect */
static PyObject *builtin_iter(PyObject *self, PyObject *const *args,
                              Py_ssize_t nargs) {
  PyObject *v;
...
static PyObject *builtin_aiter(PyObject *module, PyObject *async_iterable)
...
static PyObject *builtin_anext_impl(PyObject *module, PyObject *aiterator,
...
/*[clinic end generated code: output=f02c060c163a81fa input=2900e4a370d39550]*/
{
  ...
  if (t->tp_as_async == NULL || t->tp_as_async->am_anext == NULL) {
    PyErr_Format(PyExc_TypeError, "'%.200s' object is not an async iterator",
                 t->tp_name);
    return NULL;
  }
...
static PyObject *builtin_locals_impl(PyObject *module)
/*[clinic end generated code: output=b46c94015ce11448 input=7874018d478d5c4b]*/
{
  return _PyEval_GetFrameLocals();
}

static PyObject *min_max(PyObject *const *args, Py_ssize_t nargs,
                         PyObject *kwnames, int op) {
  ...
  if (nargs == 0) {
    PyErr_Format(PyExc_TypeError, "%s expected at least 1 argument, got 0",
                 name);
    return NULL;
  }

  if (kwnames != NULL &&
      !_PyArg_ParseStackAndKeywords(args + nargs, 0, kwnames, _parser, &keyfunc,
                                    &defaultval)) {
    return NULL;
  }
...
/* AC: cannot convert yet, waiting for *args support */
static PyObject *builtin_min(PyObject *self, PyObject *const *args,
                             Py_ssize_t nargs, PyObject *kwnames) {
  return min_max(args, nargs, kwnames, Py_LT);
}

PyDoc_STRVAR(min_doc, "min(iterable, *[, default=obj, key=func]) -> value\n\
...
/* AC: cannot convert yet, waiting for *args support */
static PyObject *builtin_max(PyObject *self, PyObject *const *args,
                             Py_ssize_t nargs, PyObject *kwnames) {
  return min_max(args, nargs, kwnames, Py_GT);
}

PyDoc_STRVAR(max_doc, "max(iterable, *[, default=obj, key=func]) -> value\n\
...
static PyObject *builtin_oct(PyObject *module, PyObject *number)
...
static PyObject *builtin_ord(PyObject *module, PyObject *c)
...
static PyObject *builtin_pow_impl(PyObject *module, PyObject *base,
...
static PyObject *builtin_print_impl(PyObject *module, PyObject *args,
...
/*[clinic end generated code: output=3cfc0940f5bc237b input=c143c575d24fe665]*/
{
  ...
  if (sep == Py_None) {
    ...
    PyErr_Format(PyExc_TypeError, "sep must be None or a string, not %.200s",
                 Py_TYPE(sep)->tp_name);
    return NULL;
  }
  if (end == Py_None) {
    ...
    PyErr_Format(PyExc_TypeError, "end must be None or a string, not %.200s",
                 Py_TYPE(end)->tp_name);
    return NULL;
  }
  ...
  for (i = 0; i < PyTuple_GET_SIZE(args); i++) {
    ...
    PyObject *metadata = PyUnicode_FromFormat(
        " | <%s:%d>", obj->ob_type->tp_name, obj->ob_refcnt, obj);
    err = PyFile_WriteObject(metadata, file, Py_PRINT_RAW);
    if (err) {
      return NULL;
    }
  }
...
static PyObject *builtin_input_impl(PyObject *module, PyObject *prompt)
/*[clinic end generated code: output=83db5a191e7a0d60 input=159c46d4ae40977e]*/
{
  ...
  if (tty) {
    ...
    if (prompt != NULL) {
      ...
      if (stringpo == NULL)
        goto _readline_errors;
      po = PyUnicode_AsEncodedString(stringpo, stdout_encoding_str,
                                     stdout_errors_str);
...
static PyObject *builtin_repr(PyObject *module, PyObject *obj)
...
static PyObject *builtin_round_impl(PyObject *module, PyObject *number,
                                    PyObject *ndigits)
...
#define BUILTIN_SORTED_METHODDEF                                               \
  {"sorted", _PyCFunction_CAST(builtin_sorted), METH_FASTCALL | METH_KEYWORDS, \
   builtin_sorted__doc__},

static PyObject *builtin_sorted(PyObject *self, PyObject *const *args,
                                Py_ssize_t nargs, PyObject *kwnames) {
  ...
  if (PyLong_CheckExact(result)) {
    ...
    while (result == NULL) {
      ...
      if (PyLong_CheckExact(item) || PyBool_Check(item)) {
        ...
        if (overflow == 0 && (i_result >= 0 ? (b <= LONG_MAX - i_result)
                                            : (b >= LONG_MIN - i_result))) {
          i_result += b;
          Py_DECREF(item);
          continue;
...
static PyObject *builtin_isinstance_impl(PyObject *module, PyObject *obj,
...
static PyObject *builtin_issubclass_impl(PyObject *module, PyObject *cls,
                                         PyObject *class_or_tuple)
...
static PyObject *zip_new(PyTypeObject *type, PyObject *args, PyObject *kwds) {
  zipobject *lz;
  Py_ssize_t i;
  PyObject *ittuple; /* tuple of iterators */
  PyObject *result;
...
static void zip_dealloc(zipobject *lz) {
  PyObject_GC_UnTrack(lz);
...
static int zip_traverse(zipobject *lz, visitproc visit, void *arg) {
  Py_VISIT(lz->ittuple);
  Py_VISIT(lz->result);
  return 0;
}

static PyObject *zip_next(zipobject *lz) {
  Py_ssize_t i;
...
check:
  ...
  if (i) {
    ...
    return PyErr_Format(PyExc_ValueError,
                        "zip() argument %d is shorter than argument%s%d", i + 1,
                        plural, i);
  }
...
static PyObject *zip_reduce(zipobject *lz, PyObject *Py_UNUSED(ignored)) {
...
static PyObject *zip_setstate(zipobject *lz, PyObject *state) {
...
PyDoc_STRVAR(zip_doc, "zip(*iterables, strict=False)\n\
--\n\
\n\
...
static PyMethodDef builtin_methods[] = {
    ...
    BUILTIN___IMPORT___METHODDEF BUILTIN_ABS_METHODDEF BUILTIN_ALL_METHODDEF
        BUILTIN_ANY_METHODDEF BUILTIN_ASCII_METHODDEF BUILTIN_BIN_METHODDEF{
            "breakpoint", _PyCFunction_CAST(builtin_breakpoint),
            METH_FASTCALL | METH_KEYWORDS, breakpoint_doc},
    ...
    BUILTIN_DIVMOD_METHODDEF BUILTIN_EVAL_METHODDEF BUILTIN_EXEC_METHODDEF
        BUILTIN_FORMAT_METHODDEF{"getattr", _PyCFunction_CAST(builtin_getattr),
                                 METH_FASTCALL, getattr_doc},
    ...
    BUILTIN_ANEXT_METHODDEF BUILTIN_OCT_METHODDEF BUILTIN_ORD_METHODDEF
        BUILTIN_POW_METHODDEF BUILTIN_PRINT_METHODDEF BUILTIN_REPR_METHODDEF
            BUILTIN_ROUND_METHODDEF BUILTIN_SETATTR_METHODDEF
                BUILTIN_SORTED_METHODDEF BUILTIN_SUM_METHODDEF{
...
static struct PyModuleDef
    builtinsmodule = {PyModuleDef_HEAD_INIT,
                      "builtins",
                      builtin_doc,
                      -1, /* multiple "initialization" just copies the module
                             dict. */
                      builtin_methods,
                      NULL,
                      NULL,
